...
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>>{
    ...
    private static String BASE_URL="https://www.juhe.cn/weather/index?format=2&cityname=";
    private String key="&key=e77b17caf20f738d343b72cd3f476281";
    ...
    protected List<Map<String, Object>> doInBackground(String... params) {
        ...
        try{
            ...
            if(response.getStatusLine().getStatusCode()==200){
                ...
                if(jsondata.getInt("resulecode")==200){
                    ...
                    for(int i=0;i<7;i++){
                        ...
                        item.put("temprature",weatherList.getString(Integer.parseInt("temperature")));
                        item.put("weather",weatherList.getString(Integer.parseInt("weather")));
                        item.put("date",weatherList.getString(Integer.parseInt("date")));
                        item.put("week",weatherList.getString(Integer.parseInt("week")));
                        item.put("wind",weatherList.getString(Integer.parseInt("wind")));
